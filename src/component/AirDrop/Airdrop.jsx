    ...
    <>
      <div className="container">
        ...
        <div className="all_launchpad_section_two">
          <span
            className={`launchpad_items ${active === 1 ? 'activeMode' : ''}`}
            onClick={() => hendleActive(1)}
          >
          ...
          <span
            className={`launchpad_items ${active === 2 ? 'activeMode' : ''}`}
            onClick={() => hendleActive(2)}
          >
            <a href="#">Advanced Mode</a>
          </span>
          <span
            className={`launchpad_items ${active === 3 ? 'activeMode' : ''}`}
            onClick={() => hendleActive(3)}
          >
        ...
        <div className="footer container">
          <p>
            ...
            any loss occasioned. It is the user(s) responsibility to do their
