      ...
      <div className='view_main'>
        <div className='view_details_left_main'>
              ...
              <div className='view_content_right'>
                ...
                <div className='sale_live_button_section'>
                  <div className='sale_live_icon'>
                    <Link style={{ border: 'none', cursor: 'pointer', backgroundColor: 'rgb(0, 188, 212)', borderRadius: '3px', textTransform: 'capitalize', padding: '3px 5px', color: '#ffffff' }}>audit</Link>
                    <div className='heartbtnholder'>
                      <div className='heart'><AiOutlineHeart /></div>
                      <div className='sale_live_button'>
                        <button style={{ border: 'none', display: 'flex', alignItems: 'center', width: '85px', cursor: 'pointer', backgroundColor: '#FDFAEA', borderRadius: '12px', textTransform: 'capitalize', padding: ' 4px 5px', color: '#D29813;' }}>
            ...
            <div className='address_details'>
              <table>
                <tr>
                  ...
                  <td className="text-right"><a href="">0x9541B7BfA98bb0aEbc0a9D68A08A5e9fBfC957Ae</a>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="text-right"><a href="">0x9541B7BfA98bb0aEbc0a9D68A08A5e9fBfC957Ae</a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className='address_list'>Initial Market Cap (estimate)</td>
                ...
                <tr>
                  ...
                  <td className="text-right"><a href="" >Pancakeswap</a></td>
                </tr>
                <tr>
          ...
          <div className='faq_section'>
            <div className="ant-card-head-wrapper">
              <div className="ant-card-head-title"><h3>Frequently Asked Question</h3></div>
            </div>
            <BlogCollapse />
          </div>
        </div>
        <div className='view_details_right'>
          ...
          <div className='cart_view'>
            ...
            <div className='forward_icon'><a href=""><GrFormDown className='down_arrow' /></a></div>
          ...
          <div className='cart_view'>
            ...
            <div className='owner_zone_description'>
              <div className='paragraph_section'>
                <p>To make sure there will be no issues during the presale time, please do not send tokens to wallets before you finalize the presale pool.</p>
              </div>
              <div className='pool_free_section'>
                <p>Pool Fee: 5% BNB raised only</p>
              </div>
              <div className='sale_Type_input'>
                <label className='sale_type' htmlFor="saletype">Sale Type</label>
                <div className='checkbutton'>
                  <span><input className='public' type="radio" /></span><span className='public_text'>Public</span>
                  <span><input className='whitelist' type="radio" /></span><span className='whitelist_text'>Whitelist</span>
                </div>
                <div className='pool_action_main'>
                  <label htmlFor="Pool Actions"><strong>Pool Actions</strong></label>
                  <div className='pool_action_details'><a href="#">Enable aFFILIATE Program</a></div>
                  <div className='pool_action_details'><a href="#">ool Start/End Time Setting</a></div>
                  <div className='pool_action_details' style={{ backgroundColor: "#f5f5f5" }}><a href="#">Finalize</a></div>
                  <div className='pool_action_details'><a href="#">ancel Pool</a></div>
                </div>
                <div className='bottom_text'>
                  <p>To Finalize presale, you have to exclude token transfer fee for presale contract.</p>
                </div>
              </div>
            </div>
          </div>
