...
const DeFiLaunchpadInfo = () => {
  ...
  return (
    <div className="difilaunchpad_section">
      <Form form={form} onFinish={validate}>
        <div className="presale_rate">
          ...
          <Form.Item
            name="presaleRate"
            rules={[
              { required: true, message: 'presale rate cannot be blank' },
            ]}
          >
            <Input type={'number'} placeholder="EX: 1000" />
          </Form.Item>
          <p style={{ color: '#fe6200' }}>
            Totle selling amount cannot be blank
          </p>
        </div>
        ...
        <div className="bnb_description">
          <div className="bnb_description_left_main">
            <label htmlFor="Softcap (BNB)*">
              Start Price (BNB)*<span style={{ color: '#FA6200' }}>*</span>
            </label>
            <Form.Item
              name="softcap"
          ...
          <div className="bnb_description_right_main">
            <label htmlFor="Softcap (BNB)*">
              End Price (BNB)*<span style={{ color: '#FA6200' }}>*</span>
            </label>
            <Form.Item
              name="hardcap"
        ...
        <div className="bnb_description">
          ...
          <div className="bnb_description_right_main">
            ...
            <Form.Item
              name="maximumbuy"
              rules={[
                { required: true, message: 'Maximum buy cannot be blank' },
              ]}
            >
              <Input type={'number'} placeholder="10000000" />
            </Form.Item>
        ...
        <div className="bnb_description">
          <div className="bnb_description_left_main">
            <label htmlFor="Softcap (BNB)*">
              Min Contribution (BNB)<span style={{ color: '#FA6200' }}>*</span>
            </label>
            <Form.Item
              name="refundtype"
              rules={[
                {
                  required: true,
                  message: 'Please endgfxfxawr the presale rate',
                },
              ]}
            >
          ...
          <div className="bnb_description_right_main">
            <label className="softcap" htmlFor="Softcap (BNB)*">
              Max Contribution (BNB)<span style={{ color: '#FA6200' }}>*</span>
            </label>
            <Form.Item
              name="router"
              rules={[{ required: true, message: 'Softcap cannot be blank' }]}
        ...
        <div className="bnb_description">
          ...
          <div className="bnb_description_right_main">
            <label className="softcap" htmlFor="Softcap (BNB)*">
              Liquidity Percent (%)*<span style={{ color: '#FA6200' }}>*</span>
            </label>
            <Form.Item
              name="listingRate"
              rules={[
                { required: true, message: 'Listing rate cannot be blank' },
              ]}
            >
              <Input type={'number'} placeholder="10000000" />
        ...
        <div className="select_time_section">
          <div className="bnb_description">
            <div className="bnb_description_left_main">
              <label htmlFor="Softcap (BNB)*">
                Refund Type<span style={{ color: '#FA6200' }}>*</span>
              </label>
              <Form.Item
                name="startTimeStamp"
                rules={[
                  {
                    required: true,
                    message: 'Please select presale starting date ',
                  },
                ]}
              >
                <Input type="text" />
            ...
            <div className="bnb_description_right_main">
              ...
              <Form.Item
                name="endTimeStamp"
                rules={[
                  { required: true, message: 'Please select presale end date' },
                ]}
              >
                <Input type="text" />
                <p style={{ color: '#fe6200' }}>
                  Liquidity lock time cannot be blank
                </p>
              </Form.Item>
            </div>
          </div>
      ...
      <div className="back_and_next_button_section"></div>
