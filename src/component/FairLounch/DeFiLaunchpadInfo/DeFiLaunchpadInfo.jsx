    ...
    <div className="difilaunchpad_section">
      <Form form={form} onFinish={validate}>
        ...
        <div className="bnb_description">
          <div className="bnb_description_main">
            ...
            >
              ...
              <p style={{ color: '#fe6200' }}>
                Softcap must be positive number
              </p>
              <div className="checkbox_item">
                <span className="input_container">
                  <input type="checkbox" />
                </span>
                <p>Setting max contribution?</p>
              </div>
            </Form.Item>
            <div></div>
          </div>
        ...
        <div className="bnb_description">
          <div className="bnb_description_main">
            <label htmlFor="Softcap (BNB)*">Liquidity(%)</label>
            <Form.Item
              name="refundtype"
              rules={[
                {
            ...
            >
              ...
              <p style={{ color: '#fe6200' }}>Liquidity must greater than 30</p>
              <div className="checkbox_item">
                <span className="input_container">
                  <input type="checkbox" />
                </span>
        ...
        <div className="liquidity_lockup_section">
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: 'Lock up time must be greater than 5 minutes',
              },
            ]}
          >
            <Input type={'number'} placeholder="10000000" />
