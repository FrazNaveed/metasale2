        ...
        <div className="create_lock_main">
            ...
            <div className="image_section">
              <div>
                <img
                  src={image1}
                  alt=""
                  className="inner_image_section bg_black"
                />
              </div>
              <div>
              ...
              <div>
                <img
                  src={image4}
                  alt=""
                  className="inner_image_section bg_white"
                />
              </div>
              <div>
                <img
                  src={image5}
                  alt=""
                  className="inner_image_section bg_change"
                />
              </div>
              <div>
          ...
          <div>
            <div className="address_token">
              <p>
                Token or LP Token address* <sup className="required"></sup>
              </p>
            </div>
            <div></div>
          </div>
          <div>
            ...
            >
              ...
              <Form.Item
                className="lock_until amount_label"
                label="Lock until (UTC time)"
                required
              >
                <DatePicker onChange={onChange} />
              </Form.Item>
              <Checkbox className="pink_anti_bot_system">
            ...
            <div className="nextBtn">
              <button className="create_token_button">Create Token</button>
            </div>
          </div>
        </div>
      </div>
