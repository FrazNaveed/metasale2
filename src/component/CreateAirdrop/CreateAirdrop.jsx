        ...
        <div className="create_airdrop_main">
          ...
          <div className="token_address_section">
            ...
            <form>
              ...
              <div className="bnb_description">
                <div className="bnb_description_left_main">
                  <label htmlFor="Softcap (BNB)*">
                    Fcaebook<span style={{ color: '#FA6200' }}>*</span>
                  </label>
                  <Form.Item
                    name="softcap"
                    rules={[
                      { required: true, message: 'Softcap cannot be blank' },
                    ]}
                  >
                    <Input
                      type={'number'}
                ...
                <div className="bnb_description_right_main">
                  <label htmlFor="Softcap (BNB)*">
                    Twitter<span style={{ color: '#FA6200' }}>*</span>
                  </label>
                  <Form.Item
                    name="hardcap"
                    rules={[
                      { required: true, message: 'Hardcap cannot be blank' },
                    ]}
                  >
                    <Input
                      type={'number'}
              ...
              <div className="bnb_description">
                <div className="bnb_description_left_main">
                  <label htmlFor="Softcap (BNB)*">
                    Github<span style={{ color: '#FA6200' }}>*</span>
                  </label>
                  <Form.Item
                    name="softcap"
                    rules={[
                ...
                <div className="bnb_description_right_main">
                  <label htmlFor="Softcap (BNB)*">
                    Telegram<span style={{ color: '#FA6200' }}>*</span>
                  </label>
                  <Form.Item
                    name="hardcap"
                    rules={[
              ...
              <div className="bnb_description">
                <div className="bnb_description_left_main">
                  <label htmlFor="Softcap (BNB)*">
                    Instagram<span style={{ color: '#FA6200' }}>*</span>
                  </label>
                  <Form.Item
                    name="softcap"
                    rules={[
                ...
                <div className="bnb_description_right_main">
                  <label htmlFor="Softcap (BNB)*">
                    Discord<span style={{ color: '#FA6200' }}>*</span>
                  </label>
                  <Form.Item
                    name="hardcap"
                    rules={[
              ...
              <div className="create_toukan_button_section">
                ...
                <button className="create_toukan_button">
                  Create New Airdrop
                </button>
              </div>
            </form>
          ...
          <footer>
            <div className="footer container">
              <p>
                Disclaimer: MetaSale will never endorse or encourage that you
                ...
                advice from a professional. More information about (DYOR) can be
                found via <span>Binance Academy</span>
              </p>
            </div>
          </footer>
        </div>
